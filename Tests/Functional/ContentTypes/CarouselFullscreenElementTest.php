...
class CarouselFullscreenElementTest extends BaseContentTypeTest
{
    public function testCarouselFullscreenContentElement(): void
    {
        ...
        $contentElement = $fullTree['content']['colPos0'][22];
        ...
        // general tests
        $this->checkDefaultContentFields($contentElement, 23, 1, 'carousel_fullscreen', 0, 'SysCategory1Title,SysCategory2Title');
