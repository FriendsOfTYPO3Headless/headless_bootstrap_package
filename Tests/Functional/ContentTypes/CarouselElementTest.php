...
class CarouselElementTest extends BaseContentTypeTest
{
    public function testCarouselContentElement(): void
    {
        ...
        $contentElement = $fullTree['content']['colPos0'][20];
        ...
        // general tests
        $this->checkDefaultContentFields($contentElement, 21, 1, 'carousel', 0, 'SysCategory1Title,SysCategory2Title');
