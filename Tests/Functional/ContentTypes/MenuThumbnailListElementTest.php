...
class MenuThumbnailListElementTest extends BaseContentTypeTest
{
    public function testMenuThumbnailListContentElement(): void
    {
        ...
        $contentElement = $fullTree['content']['colPos0'][12];
        ...
        // general tests
        $this->checkDefaultContentFields($contentElement, 13, 1, 'menu_thumbnail_list', 0, 'SysCategory1Title,SysCategory2Title');
