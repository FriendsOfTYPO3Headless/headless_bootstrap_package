 ...
 *
 * todo: Remove as soon as PR https://github.com/TYPO3-Headless/headless/pull/417 is merged and released.
 *
 * @codeCoverageIgnore
 */
    ...
    protected function processFiles(array $dimensions = []): ?array
    {
        ...
        foreach ($this->fileObjects as $key => $fileObject) {
            if (isset($this->processorConfiguration['processingConfiguration.']['autogenerate.'])) {
                ...
                if (isset($this->processorConfiguration['p  rocessingConfiguration.']['autogenerate.']['retina2x']) &&
